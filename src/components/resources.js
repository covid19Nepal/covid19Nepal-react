...
function Resources(props) {
  ...
  const openSharingLink = function (message) {
    const shareUri = `https://www.addtoany.com/share#url=${encodeURI(
      'https://nepalcovid19.org/essentials'
          ...
          <React.Fragment>
            ...
            <div className="resourcefilters">
              ...
              <button
                ...
                disabled={!nepalstate}
                onClick={filterTable}
                style={!nepalstate ? {pointerEvents: 'none'} : null}
              >
                Search
              </button>
            </div>
            ...
            >
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSceHi9Hq2V5agvqCGWfLm8hn-6FLHYWTQ2tvgYTk32vjQLayg/viewform"
                className="button add-entry is-purple"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSfG1YzX7GFyzvkwwb7reSMcvir9Mwlwt-co6EndY7ss0RYoEg/viewform"
                className="button add-entry is-purple"
                target="_blank"
                rel="noopener noreferrer"
                style={{margin: '0rem 0.2rem', padding: '0.1rem 0.5rem'}}
